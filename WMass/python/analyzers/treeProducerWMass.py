...
wmass_recoilVariables=[
    ...
    NTupleVariable('hgen_allmet_n',                     lambda ev : getattr(ev,'hgen_allmet_n'),                    mcOnly=True,  help='candidate multiplicity for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_pt',                    lambda ev : getattr(ev,'hgen_allmet_pt'),                   mcOnly=True,  help='recoil pt for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_phi',                   lambda ev : getattr(ev,'hgen_allmet_phi'),                  mcOnly=True,  help='recoil phi for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_scalar_sphericity',     lambda ev : getattr(ev,'hgen_allmet_scalar_sphericity'),    mcOnly=True,  help='scalar sphericity |h|/hT for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_scalar_ht',             lambda ev : getattr(ev,'hgen_allmet_scalar_ht'),            mcOnly=True,  help='hT for gen allmet', storageType='H'),   
    NTupleVariable('hgen_allmet_leadpt',                lambda ev : getattr(ev,'hgen_allmet_leadpt'),               mcOnly=True,  help='leading candidate pt for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_leadphi',               lambda ev : getattr(ev,'hgen_allmet_leadphi'),              mcOnly=True,  help='leading candidate phi for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_thrustMinor',           lambda ev : getattr(ev,'hgen_allmet_thrustMinor'),          mcOnly=True,  help='thrust minor for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet_thrustMajor',           lambda ev : getattr(ev,'hgen_allmet_thrustMajor'),          mcOnly=True,  help='thrust major for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet_thrust',                lambda ev : getattr(ev,'hgen_allmet_thrust'),               mcOnly=True,  help='thrust for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet_oblateness',            lambda ev : getattr(ev,'hgen_allmet_oblateness'),           mcOnly=True,  help='oblateness for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet_thrustTransverse',      lambda ev : getattr(ev,'hgen_allmet_thrustTransverse'),     mcOnly=True,  help='thrust transverse for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet_thrustTransverseMinor', lambda ev : getattr(ev,'hgen_allmet_thrustTransverseMinor'),mcOnly=True,  help='thrust transverse minor for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet_sphericity',            lambda ev : getattr(ev,'hgen_allmet_sphericity'),           mcOnly=True,  help='mom. tensor sphericity for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_aplanarity',            lambda ev : getattr(ev,'hgen_allmet_aplanarity'),           mcOnly=True,  help='mom. tensor aplanarity for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_C',                     lambda ev : getattr(ev,'hgen_allmet_C'),                    mcOnly=True,  help='mom. tensor C for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_D',                     lambda ev : getattr(ev,'hgen_allmet_D'),                    mcOnly=True,  help='mom. tensor D for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_detST',                 lambda ev : getattr(ev,'hgen_allmet_detST'),                mcOnly=True,  help='transverse mom. tensor determinant for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_rho',                   lambda ev : getattr(ev,'hgen_allmet_rho'),                  mcOnly=True,  help='median energy density for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_tau1',                  lambda ev : getattr(ev,'hgen_allmet_tau1'),                 mcOnly=True,  help='1-jettinness for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_tau2',                  lambda ev : getattr(ev,'hgen_allmet_tau2'),                 mcOnly=True,  help='2-jettinness for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_tau3',                  lambda ev : getattr(ev,'hgen_allmet_tau3'),                 mcOnly=True,  help='3-jettinness for gen allmet', storageType='H'),
    NTupleVariable('hgen_allmet_tau4',                  lambda ev : getattr(ev,'hgen_allmet_tau4'),                 mcOnly=True,  help='4-jettinness for gen allmet', storageType='H'),
    
    NTupleVariable('hgen_allmet5_n',                     lambda ev : getattr(ev,'hgen_allmet5_n'),                    mcOnly=True,  help='candidate multiplicity for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_pt',                    lambda ev : getattr(ev,'hgen_allmet5_pt'),                   mcOnly=True,  help='recoil pt for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_phi',                   lambda ev : getattr(ev,'hgen_allmet5_phi'),                  mcOnly=True,  help='recoil phi for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_scalar_sphericity',     lambda ev : getattr(ev,'hgen_allmet5_scalar_sphericity'),    mcOnly=True,  help='scalar sphericity |h|/hT for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_scalar_ht',             lambda ev : getattr(ev,'hgen_allmet5_scalar_ht'),            mcOnly=True,  help='hT for gen allmet (eta 5)', storageType='H'),   
    NTupleVariable('hgen_allmet5_leadpt',                lambda ev : getattr(ev,'hgen_allmet5_leadpt'),               mcOnly=True,  help='leading candidate pt for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_leadphi',               lambda ev : getattr(ev,'hgen_allmet5_leadphi'),              mcOnly=True,  help='leading candidate phi for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_thrustMinor',           lambda ev : getattr(ev,'hgen_allmet5_thrustMinor'),          mcOnly=True,  help='thrust minor for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet5_thrustMajor',           lambda ev : getattr(ev,'hgen_allmet5_thrustMajor'),          mcOnly=True,  help='thrust major for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet5_thrust',                lambda ev : getattr(ev,'hgen_allmet5_thrust'),               mcOnly=True,  help='thrust for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet5_oblateness',            lambda ev : getattr(ev,'hgen_allmet5_oblateness'),           mcOnly=True,  help='oblateness for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet5_thrustTransverse',      lambda ev : getattr(ev,'hgen_allmet5_thrustTransverse'),     mcOnly=True,  help='thrust transverse for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet5_thrustTransverseMinor', lambda ev : getattr(ev,'hgen_allmet5_thrustTransverseMinor'),mcOnly=True,  help='thrust transverse minor for gen PCA', storageType='H'),
    NTupleVariable('hgen_allmet5_sphericity',            lambda ev : getattr(ev,'hgen_allmet5_sphericity'),           mcOnly=True,  help='mom. tensor sphericity for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_aplanarity',            lambda ev : getattr(ev,'hgen_allmet5_aplanarity'),           mcOnly=True,  help='mom. tensor aplanarity for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_C',                     lambda ev : getattr(ev,'hgen_allmet5_C'),                    mcOnly=True,  help='mom. tensor C for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_D',                     lambda ev : getattr(ev,'hgen_allmet5_D'),                    mcOnly=True,  help='mom. tensor D for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_detST',                 lambda ev : getattr(ev,'hgen_allmet5_detST'),                mcOnly=True,  help='transverse mom. tensor determinant for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_rho',                   lambda ev : getattr(ev,'hgen_allmet5_rho'),                  mcOnly=True,  help='median energy density for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_tau1',                  lambda ev : getattr(ev,'hgen_allmet5_tau1'),                 mcOnly=True,  help='1-jettinness for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_tau2',                  lambda ev : getattr(ev,'hgen_allmet5_tau2'),                 mcOnly=True,  help='2-jettinness for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_tau3',                  lambda ev : getattr(ev,'hgen_allmet5_tau3'),                 mcOnly=True,  help='3-jettinness for gen allmet (eta 5)', storageType='H'),
    NTupleVariable('hgen_allmet5_tau4',                  lambda ev : getattr(ev,'hgen_allmet5_tau4'),                 mcOnly=True,  help='4-jettinness for gen allmet (eta 5)', storageType='H'),
]
